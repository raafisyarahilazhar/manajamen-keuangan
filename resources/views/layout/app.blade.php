...
<head>
  ...
  <title>@yield('title') | Sunforus Admin</title>
...
{{-- 
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('create-barang')) ? '' : 'collapsed' }}" href="/create-barang">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('create-laporan')) ? '' : 'collapsed' }}" href="/create-laporan">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Sunforus</span></strong>. All Rights Reserved
    </div>
  </footer>
  <!-- End Footer -->
